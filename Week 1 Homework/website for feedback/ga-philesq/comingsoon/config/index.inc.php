 ...
 *
 *forked from github @lightcastercoldheart 
 / alvarezmelvin@me.com
 */
...
$_CONFIG['meta_keywords'] = 'philesq, louis alvarado';
// Page title; required
$_CONFIG['title'] = 'Philesq - coming soon...';
// Photo; required
// -- Filename, relative to images directory from base_url
$_CONFIG['photo']['filename'] = 'soon.jpg';
// -- Alt text
$_CONFIG['photo']['alt'] = 'Philesq Soon';
// -- Height in pixels
$_CONFIG['photo']['height_px'] = 772;
// -- Width in pixels
$_CONFIG['photo']['width_px'] = 842;
